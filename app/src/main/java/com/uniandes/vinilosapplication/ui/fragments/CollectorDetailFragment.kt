    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.collectorDetail.observe(viewLifecycleOwner, Observer<CollectorModel> {
            it.apply {
                ...
                /*val collectorImage = view!!.findViewById<ImageView>(R.id.iv_collector_picture)
                picasso.load(this.image).resize(600, 600).transform(CircleTransform()).into(collectorImage)*/
